# Establish libraries
# this will need to be installed by using pip, if opening for the first time.
import pysolar
import datetime
...
print('Date:', date, name, 'timezone', sep=" ",
      file=open("solar_data.txt", "a"))
print('\nAltitude:', TFR_altitude, 'degrees',
      sep=" ", file=open("solar_data.txt", "a"))
print('Azimuth:', TFR_azimuth, 'degrees',
      sep=" ", file=open("solar_data.txt", "a"))
print('Irradiance:', TFR_irradiance, 'W/m^2',
      sep=" ", file=open("solar_data.txt", "a"))
...
# Print out results
print('\nPanel area:', Panel_area, 'm^2',
      sep=" ", file=open("solar_data.txt", "a"))
print('Panel power with Panel size and losses:', Panel_power,
      'W', sep=" ", file=open("solar_data.txt", "a"))
